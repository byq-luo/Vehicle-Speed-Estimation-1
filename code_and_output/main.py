...
line1 = [(133, 266),(773, 266)]
line2 = [(2550,820), (670, 780)]
line3 = [(2650,1120), (400, 1090)]
line4 = [(2650,1530), (500, 1520)]
line_speed_start = [(0, 498),(1270, 498)]
line_speed_end = [(80, 308),(784, 308)]
...
#        line_speed_end = [(2650,970), (450, 940)]
    ...
    #    croped = crop(frame)
        ...
        lane1 = np.array([[505,43], [535, 44], [109, 686], [0, 499]], np.int32)
        lane2 = np.array([[537,46], [579, 40], [377, 688], [113, 688]], np.int32)
        lane3 = np.array([[583, 42], [619, 38], [633, 687], [381, 688]], np.int32)
        lane4 = np.array([[621, 39], [663, 40], [1162, 688], [636, 688]], np.int32)
        ...
        cv2.line(frame,(0, 498),(1270, 498), (255, 255, 255), 1)
        cv2.line(frame,(80, 308),(784, 308), (255, 255, 255), 1)
